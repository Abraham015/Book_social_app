...
export function approveReturnBook(http: HttpClient, rootUrl: string, params: ApproveReturnBook$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponse>> {
